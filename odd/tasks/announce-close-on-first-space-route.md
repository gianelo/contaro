...
## Progress
- Status: CLOSE-1 verified and committed as `0ad6785727fd8cde9f00b63458e9350ad2ffef26` on `fix/153-close-announcement-first-route`, branched from synchronized `dev` at `ab91e60`. CLOSE-2 remains untouched; the first PR targets `dev` and the second waits until that work is integrated.
