...
## Progress
- Status: CLOSE-1 verified and committed as `0ad6785727fd8cde9f00b63458e9350ad2ffef26`; PR #159 merged into `dev` as `c7003f3cf5557b8a4f094dbe818438e39256074a` with `verify:all` successful. CLOSE-2 behavior and tests are green on `fix/153-close-announcement-fullscreen`, branched from that merge; its commit is pending. #153 remains open until the second PR merges to `dev`.
