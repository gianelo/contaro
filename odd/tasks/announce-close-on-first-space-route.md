...
## Progress
- Status: both work units verified and committed. CLOSE-1 `0ad6785727fd8cde9f00b63458e9350ad2ffef26` merged via PR #159 into `dev` as `c7003f3cf5557b8a4f094dbe818438e39256074a`; CLOSE-2 `1f6c97572cd4601601619556959555e1e2bf0989` is on `fix/153-close-announcement-fullscreen` based on that merge. #153 remains open after the second PR merges to `dev` and is closed only when the complete fix reaches `main`, following this repository's issue-delivery convention.
